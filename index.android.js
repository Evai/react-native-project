...
var NaviModule = React.createClass({
    ...
    _renderNavBar: function() {
        const styles = {
            title: {
                fontSize: 18, textAlign: 'center', color: '#FFFFFF',
            },
            buttonStyle: {
        ...
        var routeMapper = {
            ...
            Title(route, navigator, index, navState) {
                return (
                		<View style={{flex:1,justifyContent:'center',alignSelf:'center',left:-35}}>
                    		<Text style={styles.title}>{route.title ? route.title : 'Home'}</Text>
                    </View>
                );
            }
        };
...
//var App = require('./js/nomyproject/app');
